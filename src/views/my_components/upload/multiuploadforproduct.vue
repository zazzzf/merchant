...
<script>
    ...
    export default {
        ...
        props: ['imagesList',"uploadAPI","removeAPI","uploadModel","productID",'ImageType'],
        computed: {
            OimagesList:function () {
                return this.imagesList;
            },
            otherFormData:function () {
                return {
        ...
        methods: {
            ...
            handleSuccess (res, file, fileList) { 
                ...
                this.uploadModel.newlist=this.uploadList;
            },
